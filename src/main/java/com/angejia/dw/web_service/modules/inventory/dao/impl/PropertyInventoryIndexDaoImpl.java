...
public class PropertyInventoryIndexDaoImpl extends BaseDaoHibernate4<PropertyInventoryIndexEntity>
        implements PropertyInventoryIndexDao {
    ...
    public List<PropertyInventoryIndexEntity> getInventorysByEntity(PropertyInventoryIndexEntity entity, Integer offset,
        ...
        } else if (entity.getBedrooms() != null) { // 单个户型
